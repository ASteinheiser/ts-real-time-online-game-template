...
export type Web_DeleteAccountMutationVariables = Exact<{ [key: string]: never; }>;


export type Web_DeleteAccountMutation = { __typename?: 'Mutation', deleteProfile?: boolean | null };
...
export const Web_DeleteAccountDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"Web_DeleteAccount"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteProfile"}}]}}]} as unknown as DocumentNode<Web_DeleteAccountMutation, Web_DeleteAccountMutationVariables>;
