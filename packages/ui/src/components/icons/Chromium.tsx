interface ChromiumProps {
  size?: number;
  className?: string;
}

export const Chromium = ({ size = 24, className }: ChromiumProps) => {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <defs id="defs18">
        ...
        <linearGradient id="linearGradient4975">
          <stop style={{ stopColor: '#1972e7' }} offset="0" id="stop4971" />
          <stop style={{ stopColor: '#1969d5' }} offset="1" id="stop4973" />
        </linearGradient>
        <linearGradient
          xlinkHref="#3"
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0" id="stop1397" style={{ stopColor: '#afccfb' }} />
          <stop offset="1" id="stop1399" style={{ stopColor: '#8bb5f8' }} />
        </linearGradient>
        <linearGradient
          xlinkHref="#1"
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0" id="stop3122" style={{ stopColor: '#659cf6' }} />
          <stop offset="1" id="stop3124" style={{ stopColor: '#4285f4' }} />
        </linearGradient>
        <linearGradient
          xlinkHref="#2"
        ...
        />
        <linearGradient id="2">
          <stop style={{ stopColor: '#3680f0' }} offset="0" id="stop2682" />
          <stop style={{ stopColor: '#2678ec' }} offset="1" id="stop2684" />
        </linearGradient>
      </defs>
      <path
